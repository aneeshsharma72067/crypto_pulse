...
const TrendingCoin = ({ data }) => {
  ...
  return (
    <div
      className="w-[40%] bg-[#111] mb-12
    last:mb-0 rounded-lg p-4 relative cursor-pointer
    hover:bg-[#222] duration-300
    shadow-[0_0_40px_1px_rgba(0,0,0,0.6)]
    "
    ...
    >
      {data ? (
        <>
          ...
          <div
            className="w-[25%] h-auto rounded-full absolute top-2/4 -right-12 -translate-y-2/4
          "
          >
            <img src={data.large} alt={data.name} className="" />
          </div>
        </>
      ) : (
        <div

...
const Filters = () => {
  ...
  const handleCurrencySubmit = (e) => {
    ...
    if (["usd", "eur", "inr", "jpy", "aud", "cad", "cny"].includes(val))
      setCurrency(val);
    else {
      ...
      <div className="flex">
        ...
        >
          ...
          <input
            ...
            ref={currencyRef}
            placeholder="usd"
            className="px-4 w-24 rounded bg-gray-200 placeholder:text-gray-100
     pl-2 required outline-0 border border-transparent 
     focus:border-cyan leading-4 py-3 duration-300
     "
          />
          {/* <button type="submit" className="ml-1 cursor-pointer">
            <img src={submitIcon} alt="submit" className="w-8" />
          </button> */}
        </form>
        ...
        <label className="relative flex justify-center items-center">
         ...
         px-3 pr-10 py-3 leading-4 capitalize focus:outline-0
         "
            onClick={handleSort}
          >

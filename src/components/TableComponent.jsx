          ...
          <table className="w-full table-auto">
            ...
            >
              <tr className="">
                ...
                <th className="py-4 lg:table-cell hidden">1H</th>
                <th className="py-4 lg:table-cell hidden">24H</th>
                <th className="py-4 lg:table-cell hidden">7D</th>
              </tr>
            </thead>
            <tbody>
              {cryptoData.map((data) => {
            ...
            hover:bg-gray-200 last:border-b-0 duration-300
            "
                  >
                    <td className="py-4 flex items-center uppercase px-3">
                      <SaveBtn data={data} />
                      <img
                        className="w-[1.2rem] h-[1.2rem] mx-3"
                        src={data.image}
                        alt={data.name}
                      />
                      <span>
